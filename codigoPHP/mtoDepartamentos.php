...
<html lang="es">
    ...
    <body>
        <header>
            <h1>Mto. de Departamentos Tema 4 Javier</h1>
        </header>
        ...
        <?php
            ...
            if($entradaOK){ // si la entrada esta bien recojo los valores introducidos y hago su tratamiento
                ...
                try { // Bloque de código que puede tener excepciones en el objeto PDO
                    ...
                    $sqlDepartamentosLimit = 'SELECT * FROM Departamento WHERE DescDepartamento LIKE "%":DescDepartamento"%" LIMIT '.(($numPagina-1)*MAX_NUMERO_REGISTROS).','.MAX_NUMERO_REGISTROS;
            ...
            <?php 
                    if($consultaDepartamentosLimit->rowCount()>0){ // si la consulta devuelve algun registro
                        ...
                        while($oDepartamento) { // recorro los registros que devuelve la consulta de la consulta 
                            $codDepartamento = $oDepartamento->CodDepartamento; // variable que almacena el codigo del departamento

            ?>
                <tr <?php echo (($oDepartamento->FechaBaja)==null)? "class='verde'" : "class='bajaLogica'";?>>
                    ...
                    <td><?php echo (($oDepartamento->FechaBaja)==null)? "NULL": $oDepartamento->FechaBaja; // obtengo el valor de la fecha de baja del departamento del registro actual ?></td>
                    ...
                    <td>
                        ...
                        <?php if($oDepartamento->FechaBaja==null){ // si la fecha de baja es null?>
